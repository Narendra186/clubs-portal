    ...
    for i in clubs:
        ...
        for i in clubs:
            ...
            #   print(vote)
                ...
                if threshhold >10:
                    #return HttpResponse(i.club_name)
                    instance=ExistingClub.objects.create(club_name=i.club_name, club_info=i.club_info,club_logo=i.club_logo)
                    #return HttpResponse(i.name)
                    instance.admin.add(i.name)
                i.delete()
